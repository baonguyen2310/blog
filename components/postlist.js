  ...
  return (
    <>
      ...
      dark:from-purple-800 dark:to-purple-900">
            ...
            <div className="mt-3 flex items-center space-x-3 text-gray-500 dark:text-gray-400 overflow-hidden truncate">
              {
                post.authors.map((author) => {
                  return (
                    <Link
                      ...
                      legacyBehavior>
                      <div className="flex items-center gap-3m truncate">
